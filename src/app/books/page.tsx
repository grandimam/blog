...
export const metadata: Metadata = {
  ...
  description:
    "Books that shape my thinking on technology, systems, and purpose. From 'The Soul of a New Machine' to works on collective security and institutional responsibility. Reading list organized by Technology, Systems, and Purpose.",
  openGraph: {
    title: "Books | Grandimam - Reading List & Recommendations",
    description:
      "Books that shape my thinking on technology, systems, and purpose. From 'The Soul of a New Machine' to works on collective security and community building.",
    url: "https://grandimam.net/books",
  },
  twitter: {
    title: "Books | Grandimam - Reading List & Recommendations",
    description:
            ...
            {categories.map((category, categoryIndex) => {
              ...
              return (
                <section
                  ...
                  style={{
                    marginBottom:
                      categoryIndex < categories.length - 1 ? "32px" : "0",
                  }}
                >
                  <h2
                    style={{
